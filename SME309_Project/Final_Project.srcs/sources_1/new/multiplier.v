module multiplier(input_a, input_b, product, underflow, overflow);
  ...
  assign judge = exponent_a+exponent_b-8'd127;
  assign toobig = (judge>8'd255)?1:0;
  ...
  assign overflow = ((exponent_a[7] & exponent_b[7]) & ~final_exponent[7])||toobig;
