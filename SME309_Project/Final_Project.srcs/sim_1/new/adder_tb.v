...
adder DUT(.operand_1(operand_1),.operand_2(operand_2),.clk(clk),.StartF(StartF),.Sum(Sum),.valid(valid));
initial 
begin 
clk=1'b0;
StartF=1;
...
#40
$display("%b\n",Sum);
 operand_1 = 32'b0_01111111_100_0000_0000_0000_0000_0000;
 operand_2 = 32'b0_10000000_101_0000_0000_0000_0000_0000;
#40
$display("%b\n",Sum);

operand_1 = 32'b1_01111111_100_0000_0000_0000_0000_0000;
 operand_2 = 32'b1_10000000_101_0000_0000_0000_0000_0000;
#40
$display("%b\n",Sum);

operand_1 = 32'hFFFFFFFF;
operand_2 = 32'hFFFFFE00;
#40
$display("%b\n",Sum);
